                    ...
                    <div className='icon icon--moon'>
                        <svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' viewBox='0 0 512 512' id='moon'>
                            <g>
                                ...
                                ></path>
                                <circle cx='285' cy='156' r='44.5' fill='#666865' stroke='#5E5E5D'></circle>
                                <circle cx='385' cy='300' r='21.5' fill='#666865' stroke='#5E5E5D'></circle>
                                <circle cx='166' cy='296.5' r='27.84' fill='#666865' stroke='#5E5E5D'></circle>
                                <circle cx='261.25' cy='272.75' r='14.75' fill='#666865' stroke='#5E5E5D'></circle>
                                <circle cx='151.5' cy='184' r='28' fill='#666865' stroke='#5E5E5D'></circle>
                                <circle cx='297.5' cy='382.501' r='27.5' fill='#666865' stroke='#5E5E5D'></circle>
