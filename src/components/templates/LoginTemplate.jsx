...
import { AdminRegister } from '../organisms/forms/AdminRegister'
import { FooterLogin } from '../organisms/FooterLogin'
// import { useUsersStore } from '../../store/UsersStore'
// import { useMutation } from '@tanstack/react-query'

export const LoginTemplate = () => {
    // const { newUserAdmin } = useUsersStore()
    // const navigate = useNavigate()

    // const mutationInsertUser = useMutation({
    //   mutatioKey: ['insertar usuario Admin'], mutationFn: async () => {
    //     const p = {
    //       email: 'pruebas@mail.com',
    //       password: '123456'
    //     }
    //     const dt = await newUserAdmin(p)
    //     if (dt) {
    //       navigate('/')
    //     }
    //   }
...
const Container = styled.div`
    ...
    .contentCard {
        ...
        &:hover {
            ...
            .cuadros {
                transform: rotate(37deg) rotateX(5deg) rotateY(12deg) rotate(3deg) skew(2deg) skewY(1deg) scaleX(1.2)
                    scaleY(1.2);
                color: red;
            }
        }
